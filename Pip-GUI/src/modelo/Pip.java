...
public class Pip
{
    ...
    private static final String COMANDO_MOSTRAR     = "pip show %s";
    ...
    public static String actualizar(String paquete)
        throws IOException, InterruptedException
    {
        ProcesoConsola proceso = new ProcesoConsola(String.format(COMANDO_ACTUALIZAR, paquete));
        proceso.ejecutar(null);
    ...
    {
        ProcesoConsola proceso = new ProcesoConsola(String.format(COMANDO_DESINSTALAR, paquete));
        proceso.ejecutar(null);
    ...
    public static String mostrar(String paquete)
        throws InterruptedException, IOException
    {
        ProcesoConsola proceso = new ProcesoConsola(String.format(COMANDO_MOSTRAR, paquete));
        proceso.ejecutar(null);
        return proceso.getSalida();
    }
